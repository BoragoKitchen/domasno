(function ( $, x5engine ) {
	...
	s.siteId = '7EAB367FAF34A01F046A12D42B3A3415';
	s.islocal = true;
	$.extend(true, s , {
		"imCart": {
			"slugToProductIdMap": {},
	...
	b.push(function () {
		x5engine.captcha.instance = new x5engine.captcha.x5captcha({
			"offlineCodes": {
				"0": { letter: '4', path: 'captcha/imcpa_2dj.gif'},
				"1": { letter: 'Y', path: 'captcha/imcpa_meg.gif'},
				"2": { letter: '2', path: 'captcha/imcpa_28f.gif'},
				"3": { letter: 'H', path: 'captcha/imcpa_x58.gif'},
				"4": { letter: 'M', path: 'captcha/imcpa_7yp.gif'},
				"5": { letter: 'F', path: 'captcha/imcpa_rd4.gif'},
				"6": { letter: 'Z', path: 'captcha/imcpa_tmh.gif'},
				"7": { letter: 'W', path: 'captcha/imcpa_xc5.gif'},
				"8": { letter: '6', path: 'captcha/imcpa_3vx.gif'},
				"9": { letter: 'E', path: 'captcha/imcpa_ryx.gif'}
			}
		});
	}, false, 'first');
